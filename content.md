...
<--->
## <span class="cleartxt anim-text-flow" style="font-family:'YesterYear'; font-size:1.5em">Der Wasserfall</span>
...
<-->
![fun-modern_times](resources/modern_times.gif)
...
<--->
## <span class="sickHeader">Time to market</span> 
...
<--->
## <span class="words"><p class="words-line revert">agile</p><p class="words-line"><span class="cleartxt anim-text-flow">transition</span></p></span>
...
![white-agile_vs_waterfall](resources/agile-vs-waterfall-project-failure-rates.jpg)
...
## <span class="cleartxt anim-text-flow" style="font-family:'YesterYear'; font-size:1.5em">Water Scrum Fall</span>

<-->
![blank-waterscrumfall](resources/WaterAgileFall.png)
...
## <span class="words"><p class="words-line revert">Navy</p><p class="words-line"><span class="cleartxt anim-text-flow">SEAL</span></p></span>
...
<-->
## <span class="cleartxt anim-text-flow">Sea, Air, Land</span>

Note:
- Crossfunktional

<-->
## <span class="words"><p class="words-line revert">Cross</p><p class="words-line"><span class="cleartxt anim-text-flow">Functional</span></p></span>
...
<-->
![fun-multitasking](resources/multitasking.gif)
...
<-->
> 50% of team members are motivated more by<span class="cleartxt anim-text-flow">team success</span>
than by the company’s 27% or individual’s 23% personal goals. (Source: Atlassian)


<--->

![white-wewantyou](resources/we-want-you.png)
...
<--->
## <span class="words"><p class="words-line revert">Was?</p><p class="words-line"><span class="cleartxt anim-text-flow">Wie?</span></p></span>
...
<-->
## <span class="words"><p class="words-line revert">Inspect</p><p class="words-line"><span class="cleartxt anim-text-flow">+ Adapt</span></p></span>

<-->

![user focus](resources/user_focus.png)
<--->
## <span class="words"><p class="words-line revert">Scrum</p><p class="words-line"><span class="cleartxt anim-text-flow">Values</span></p></span>

Note:
- Also wie ist denn die Scrum Kultur so

<--->
### <span class="txt anim-text-flow">Courage</span>  
...
<--->
### <span class="txt anim-text-flow">Focus</span>
...
<-->
> <span style="font-size:2em"><span style="color:red;font-family:'Ewert'">Stop</span> Starting<br/>
> <span style="color:green;font-family:'Ewert'">Start</span> Finishing</span>

Note:
- Fangt nix an, was ihr nicht zu Ende bringen könnt

<--->
### <span class="txt anim-text-flow">Commit ment</span>

Note:
- Löwenmama (Scrum Master fürs TEam, Team fürs Produkt)

<-->
![white-wonderwomwan](resources/wonderwomen.gif)

Note:
- DOR und DOD
- INVEST (Unabhängig, verhandelbar, wertvoll, schätzbar, klein, testbar)
<--->
### <span class="txt anim-text-flow">Respect</span>

<-->
![blank-stronger_together](resources/stronger_together.gif)
Note:
- Hochstapler-Syndrom
- DIE Entwickler, DIE Admins, DIE ...

<--->
### <span class="txt anim-text-flow">Openness</span>
...
<-->
![blank-much_to_learn](resources/much_to_learn.gif)
...
## <span class="cleartxt anim-text-flow">Software Crafting</span>

<--->

## Continuous Delivery
<span class="sick-line-trough">Continuous Integration</span>

<-->

### <span class="words"><p class="words-line revert">Write</p><p class="words-line"><span class="cleartxt anim-text-flow">Tests</span></p></span>
...
<--->
## <span class="words"><p class="words-line revert">Mob</p><p class="words-line"><span class="cleartxt anim-text-flow">Programming</span></p></span>
...
- Der Mob schafft <span class="simple anim-text-flow">Mut</span> innovativ zu sein und sich gemeinsam zu entwickeln
- Er stellt sicher das der <span class="simple anim-text-flow">Fokus</span> stets auf dem Wichtigen liegt
- Der Mob teilt Verantwortung, Rückschläge und Erfolge auf
- Es entsteht eine Atmosphäre aus <span class="simple anim-text-flow">Respekt</span> und <span class="simple anim-text-flow">Transparenz</span>
...
<-->
![solo-vs-mob](resources/solo-vs-mob-task-switching.png)

<-->
![white-horizontal_work](resources/HorizontaleArbeit.png)

Note:
- Das ist jetzt wieder das Beispiel aus dem Wasserfall oder iterativen Wasserfall

<-->
![white-mob_work](resources/MobProgramming.png)
...
## <span class="cleartxt anim-text-flow">Become a mob</span>
